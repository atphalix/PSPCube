...
#ifdef PSP
	M_Print (16, 72, "      Analog Nub Speed");
#else
...
#ifdef PSP
	M_Print (16, 104, "     Invert Analog Nub");
#else
	M_Print (16, 104, "          Invert Mouse");
#endif
	M_DrawCheckbox (220, 104, m_pitch.value < 0);

	M_Print (16, 112, "    Disable Analog Nub");

	M_DrawCheckbox (220, 112, in_disable_analog.value );

	M_Print (16, 120, "            Music Type");
	if (strcmpi(bgmtype.string,"cd") == 0)
		M_Print (220, 120, "CD/MP3");
	else
		M_Print (220, 120, "None");
#ifdef PSP_HARDWARE_VIDEO
	M_Print (16, 128, "     Water tranparency");
	M_DrawSlider (220, 128, r_wateralpha.value);

	M_Print (16, 136, "    Texture Scale Down");
	M_DrawCheckbox (220, 136, r_tex_scale_down.value);

	M_Print (16, 144, "      Simple Particles");
	M_DrawCheckbox (220, 144, r_particles_simple.value);
#endif
// cursor
