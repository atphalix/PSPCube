...
void Host_Init (quakeparms_t *parms)
{
	...
	Con_Printf ("PSP Quake1 v 1.0 (Exe: "__TIME__" "__DATE__")\n");
	...
	#else
		Con_Printf ("SW Rendering - Kernel Mode \n");
	#endif
#else
  	#ifdef PSP_HARDWARE_VIDEO
		Con_Printf ("HW Rendering - User Mode \n");
	#else
		Con_Printf ("SW Rendering - User Mode \n");
	#endif
#endif
